...
public class Consumer {
    ...
    public static void main(String[] args) throws InterruptedException, TimeoutException {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "europe-kafka-bootstrap-kafka-europe.apps.cluster-9d8f.9d8f.example.opentlc.com:443");
        //props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "us-kafka-bootstrap-kafka-us.apps.cluster-9d8f.9d8f.example.opentlc.com:443");
        ...
        props.put(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, "Eqt8NyVQktOm");
        //props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, "../cluster-us.p12");
        //props.put(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, "gIH4YU51sJxd");
